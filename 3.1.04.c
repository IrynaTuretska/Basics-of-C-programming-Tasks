...
Используя символы табуляции или модификаторы формата, измените вызов функции printf так, чтобы получалась красивая табличка. Учтите, что позиции табуляции у вас и в проверяющей системе могут иметь различные значения.
